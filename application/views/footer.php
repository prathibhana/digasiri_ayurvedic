...
<footer class="main-footer">
	<strong>Digasiri Ayurvedic Channelling System &copy; 2020</strong> All rights reserved.
</footer>
<!-- ================== End Footer ============================ -->
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<a href="<?php echo base_url()?>login/login/logout" class="btn btn-success"> Yes </a>
			</div>
		</div>
	</div>
</div>
